...
from escola.validators import cpf_invalido, nome_invalido, celular_invalido, codigo_invalido
...
class CursoSerializer(serializers.ModelSerializer):
    ...
    def validate(self,dados):
        if codigo_invalido(dados['codigo']):
...
class ListaMatriculasEstudanteSerializer(serializers.ModelSerializer):
    ...
    def get_periodo(self,obj):
        return obj.get_periodo_display() # Retorna o valor legível do campo 'periodo'
